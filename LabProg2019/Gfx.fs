...
type CharInfo with
    ...
    static member filledMenu (fg : Color, ?bg : Color) = CharInfo.create (Config.filled_pix_menu, fg, ?bg = bg)
    static member filledSubMenu= CharInfo.create (Config.filled_sub_menu, Color.Cyan)
    static member filledGhost (fg : Color, ?bg : Color) = CharInfo.create (Config.fillghost, fg, ?bg = bg)
    static member fillball (fg : Color, ?bg : Color) = CharInfo.create (Config.fillball, fg, ?bg = bg)              
    static member FilledPacman (fg : Color, ?bg : Color) = CharInfo.create (Config.fillpacman, fg, ?bg = bg)
    static member fillWallForPacman (fg : Color, ?bg : Color) = CharInfo.create (Config.WallForPacman, fg, ?bg = bg)
